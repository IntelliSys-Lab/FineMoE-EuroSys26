...
3. Send a notice in the HotCRP comment to confirm your address with us.

4. We will approve your ZeroTier join request as soon as possible.

5. After joining our network, you should be able to ssh into the machine via:
```
ssh root@10.144.136.46
```
...
6. Execute the baselines. We provide four baselines in this demo:
```
python eval.py --offload deepspeed  # DeepSpeed Inference
