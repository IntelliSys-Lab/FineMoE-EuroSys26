...
public:
    ArcherPrefetchHandle(const std::string& prefix, const double device_memory_ratio, const std::string& offload_method);
    ...
    void ClearCache();
    void SetCacheLimit(const std::size_t limit);
