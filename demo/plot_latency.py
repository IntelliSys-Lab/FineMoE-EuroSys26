...
# =============================================================
# Figure 10: Offline latency bars (TTFT / TPOT / Hit Rate) per baseline
# =============================================================
...
offline_pat = re.compile(
    r"^offline~([^~]+)~([^~]+)~([^~]+)\.csv$", re.IGNORECASE)

# ------------------ Helpers ------------------


def read_offline_csv(path: str):
